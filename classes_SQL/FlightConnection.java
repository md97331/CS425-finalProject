...
public class FlightConnection {
    ...
    public FlightConnection(int FlightID, int Distance, String Origin,
                  ...
                  int PsgLimitCOMF, int PsgLimitPREM, int PsgLimitBUSS, int PsgLimitFIRST, int connectionID,
                  String cArrivalTime, String cDepartureTime, String airportConnection) {
